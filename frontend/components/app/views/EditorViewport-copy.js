...
import { StyledPrivateButton, StyledSitemap } from "@/components/styledComponents/StyledElements";
          ...
          >
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
              <>
                ...
                <StyledContentBox className="theme__overflow-x theme__overflow-y theme__height-100">
                  <TransformComponent
